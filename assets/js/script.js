                ...
                cards.innerHTML += `
                        <div class="card" data-id="${product.id}">
                            ...
                            <div class="card-content">
                                <h2 class="card-title">${product.title.slice(0, 15)}...</h2>
                            ...
                            <button class="btn btn-primary add-to-cart" id="${product.id}">Add Basket</button>
                        </div>
        `;
        });
}
...
if (users.length > 0) {
    ...
    users = [{ username: "", basket: [] }];
    userIndex = 0;
}
let basket = users[userIndex].basket || [];
